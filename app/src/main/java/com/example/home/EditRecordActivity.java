...
public class EditRecordActivity extends AppCompatActivity {
    ...
    private EditText pNameEt , pAgeEt , pWeightEt , pHeightEt;
    Button saveInfoBt;
    ActionBar actionBar;
    ...
    private String id, name,age,weight,height;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(editMode) {
            ...
            pAgeEt.setText(age);
            pWeightEt.setText(weight);
            pHeightEt.setText(height);
        ...
        saveInfoBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getData();
                startActivity(new Intent(EditRecordActivity.this, PlusButton.class));
    ...
    private void getData() {
        ...
        weight = ""+pWeightEt.getText().toString().trim();
        height = ""+pHeightEt.getText().toString().trim();
    ...
    public boolean onSupportNavigateUp() {
        //moves our add record activity to main activity when back button pressed
        onBackPressed();
