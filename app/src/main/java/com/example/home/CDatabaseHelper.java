...
public class CDatabaseHelper extends SQLiteOpenHelper {
    public CDatabaseHelper(@Nullable Context context) {
        super(context, com.example.home.CalorieConstants.DB_NAME, null, com.example.home.CalorieConstants.DB_VERSION);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(com.example.home.CalorieConstants.CREATE_TABLE);
    }
